...
const PinterestWidget = () => {
  ...
  return (
    <div 
      className="fixed top-20 left-6 right-6 h-28 bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200 transition-all duration-300 hover:scale-105 hover:shadow-xl cursor-pointer"
